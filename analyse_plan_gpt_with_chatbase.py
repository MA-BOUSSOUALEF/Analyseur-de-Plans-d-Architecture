...
{
  "pieces": [
    { "description": "Salon au centre, environ 25m², 5m x 5m, 2 portes, 1 fenêtre..." }
  ],
  "murs": [
    { "description": "Mur nord, porteur intérieur, environ 4m de long..." }
  ],
  "escalier": {
    "description": "Escalier droit au sud, largeur environ 1m..."
  }
}
            """
...
def main():
    ...
    with col2:
        ...
        if st.session_state.analysis_results:
            ...
            # (reste du code Chatbot inchangé)
            ...
        else:
